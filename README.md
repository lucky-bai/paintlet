...
- **Save / Open** — opens PNG, JPEG, GIF, WebP, BMP, and HEIC; one-step save as PNG, JPEG, or BMP, picked from the save panel's format popup. The title bar tracks the file and unsaved changes.
